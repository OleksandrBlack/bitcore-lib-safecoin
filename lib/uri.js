 ...
 * ```javascript
 *
 * var uri = new URI('safecoin:RqgE2MgJiqkB4ZoZacBSeH1nA7VKXh5nH5?amount=1.2');
 ...
 * ```javascript
 *
 * var valid = URI.isValid('safecoin:RqgE2MgJiqkB4ZoZacBSeH1nA7VKXh5nH5');
 * // true
 * ```
 *
 * @param {string|Object} data - A bitcoin URI string or an Object
...
URI.parse = function(uri) {
  ...
  if (info.protocol !== 'safecoin:') {
    throw new TypeError('Invalid safecoin URI');
  }
...
URI.prototype._fromObject = function(obj) {
  ...
  if (!Address.isValid(obj.address)) {
    throw new TypeError('Invalid safecoin address');
  }
