...
We're working hard to make *bitcore* the most powerful JavaScript library for working with safecoin. Our goal is to have *bitcore* be a library that can be used by anyone interested in safecoin, and to level expertise differences with great design and documentation.
...
- https://discord.gg/N4XT8n6 (Safecoin Discord)
...
```
Finally go to [github.com/Fair-Exchange/bitcore-lib-safecoin](https://github.com/Fair-Exchange/bitcore-lib-safecoin) in your web browser and issue a new pull request.
...
[github.com/Fair-Exchange/bitcore-lib-safecoin/issues](https://github.com/Fair-Exchange/bitcore-lib-safecoin/issues).
